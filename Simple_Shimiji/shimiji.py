...
idle_image = tk.PhotoImage(file='Place_The_Path_To_Your_Gif_Here')  # Idle image
# For walking Left and right
left_walk_frames = [tk.PhotoImage(file='Place_The_Path_To_Your_Gif_Here', format=f'gif -index {i}') for i in range(2)]  # 2 frames
right_walk_frames = [tk.PhotoImage(file='Place_The_Path_To_Your_Gif_Here', format=f'gif -index {i}') for i in range(2)]  # 2 frames
